...
| [[FORK] MenuManager](https://github.com/Starter1552/MenuManagerCS2-FORK](https://github.com/Stimayk/MenuManagerCS2) | ❌ | Кнопочное меню (WASD + E/R). Без него — стандартное меню CSS |
...
Результат: `bin/Release/net8.0/VoteSystem.dll`
